...
(function () {
  ...
  function buildReport(rep, meta) {
    ...
    ch.push(H(tr("3. Синов ўтказиш жойи ва услублари (методикаси)", "3. Место и методы (методика) проведения испытания")),
      P(tr(
        (meta.site ? "Синов " + meta.site + "да ўтказилди. " : "") + meta.preparatName + " препарати биологик самарадорлиги давлат синов методикаси бўйича, ҳосилдорлик эса Б.А. Доспехов (1985) усулида олиб борилди. Ҳисоблаш методикаси: " + rep.efficacyMethodLabel + ".",
