...
(function () {
  ...
  function buildReport(rep, meta) {
    ...
    ch.push(P(city + " – 2026 й.", { align: "center", bold: true, before: 4800, after: 0 }),
    ...
    if (rep.storage) {
      ...
      ch.push(H("КИРИШ"),
        P("Қишлоқ хўжалиги маҳсулотларини етиштириш билан бир қаторда, уларни йиғим-теримдан кейин сифатли сақлаш ва нобудгарчиликни камайтириш ҳам озиқ-овқат хавфсизлигини таъминлашнинг муҳим шартларидан биридир. Жаҳон миқёсида йиғиб олинган мева ва сабзавот маҳсулотларининг сезиларли қисми — айрим маълумотларга кўра 20–40% гача — сақлаш ва ташиш жараёнида нобуд бўлади. Шу боис сақлаш муддатини узайтириш ва маҳсулот сифатини сақлаб қолиш илмий ҳамда амалий жиҳатдан долзарб вазифа ҳисобланади.", { indent: true }),
        P(crop + " маҳсулоти республика деҳқончилигида ва экспорт салоҳиятида муҳим ўрин тутади. Унинг тижорат қиймати кўп жиҳатдан йиғим-теримдан кейинги сифати — ташқи кўриниши, турғорлиги, таъми ва сақланиш муддатига боғлиқ. Сақлаш жараёнида маҳсулот физиологик ва микробиологик ўзгаришларга учрайди, натижада унинг сифат кўрсаткичлари пасаяди.", { indent: true }),
        P("Сақлаш даврида сифатни пасайтирувчи асосий омиллардан бири — " + org + " ҳисобланади. Бундай касалликлар маҳсулот тўқималарини бузади, сув йўқотилишини кучайтиради ва товар кўринишини йўқотиб, сақлаш муддатини қисқартиради. Назорат қилинмаган ҳолда улар сақланаётган маҳсулотнинг катта қисмини нобуд қилиши мумкин.", { indent: true }),
        P("Сақлашдаги нобудгарчиликни камайтириш учун ҳарорат ва намликни бошқариш (совутгичли сақлаш), маҳсулотни қадоқлаш ҳамда биологик ва кимёвий консервант/ҳимоя воситаларидан фойдаланиш каби усуллар қўлланилади. Айни вақтда истеъмолчи хавфсизлигини таъминлаш мақсадида кам қолдиқли, экологик хавфсиз ва фитотоксик таъсирга эга бўлмаган воситаларга устунлик берилади.", { indent: true }),
        P("Ҳар қандай янги сақлаш воситаси амалиётга кенг жорий этилишидан аввал белгиланган методикалар асосида давлат синовидан ўтказилиши, унинг биологик самарадорлиги, маҳсулот сифатига таъсири ва хавфсизлиги маҳаллий шароитда текширилиши шарт.", { indent: true }),
        P("Мазкур илмий ҳисобот " + prep + " (таъсир этувчи модда – " + ai + ") воситасининг " + crop + " маҳсулотини сақлаш жараёнида " + org + "га қарши биологик самарадорлигини аниқлашга бағишланган. Тадқиқотнинг асосий мақсади — воситанинг " + meta.applicationRate + " сарф меъёридаги самарадорлигини баҳолаш, уни эталон (андоза) " + meta.referenceName + " билан таққослаш, маҳсулот турғорлиги ва сифатига таъсирини ўрганиш ҳамда Давлат рўйхатига киритиш бўйича асосланган хулоса тайёрлашдан иборат. Синов " + meta.site + "да, «" + variety + "» навида ўтказилди.", { indent: true }));
      // ——— Сақлаш синови учун Адабиётлар шарҳи ———
      ch.push(H("1. Адабиётлар шарҳи"),
        P("Мева ва сабзавот маҳсулотларини йиғим-теримдан кейин сақлаш ҳамда сифатини баҳолаш халқаро миқёсда стандартлаштирилган ёндашувларга асосланади. Европа ва Ўрта ер денгизи ўсимликларни ҳимоя қилиш ташкилоти (EPPO), БМТнинг Озиқ-овқат ва қишлоқ хўжалиги ташкилоти (FAO) ҳамда Кодекс Алиментариус комиссияси йиғим-теримдан кейинги ишлов ва сифат мезонлари бўйича ягона тамойилларни белгилайди [1, 2].", { indent: true }),
        P("Йиғим-теримдан кейинги касалликлар (масалан, кулранг чириш — Botrytis cinerea ва бошқа замбуруғли касалликлар) паст ҳарорат ва юқори намлик шароитида ҳам ривожланиши, маҳсулот тўқималарини бузиши ва сақлаш давомида йирик нобудгарчиликка сабаб бўлиши хорижий тадқиқотларда кўрсатилган [3, 4]. Ушбу касалликларнинг ривожланиши маҳсулот физиологияси, ҳарорат ва намлик режими билан узвий боғлиқ.", { indent: true }),
        P("Таъсир этувчи модда " + ai + " ва унга ўхшаш консервант/ҳимоя воситалари бўйича хорижий адабиётларда уларнинг антимикроб ва замбуруғга қарши таъсир механизми батафсил ўрганилган. Тадқиқотларда бундай воситалар патоген ҳужайра деворига таъсир қилиб, спора ривожланишини секинлаштириши ва фитотоксик таъсир кўрсатмасдан маҳсулот сифатини сақлашга ёрдам бериши қайд этилган [5, 6, 7].", { indent: true }),
        P("Сақлаш самарадорлиги ҳарорат, нисбий намлик, қадоқлаш усули, восита сарф меъёри ва қўллаш муддатига боғлиқлиги халқаро тадқиқотларда алоҳида таъкидланади. Кўплаб муаллифлар совутгичли сақлаш ва тегишли ишлов бирга қўлланганда сақлаш муддати сезиларли узайишини кўрсатган [8, 9].", { indent: true }),
        P("Маҳаллий ва МДҲ мамлакатлари тадқиқотчилари ишларида тажрибаларни ташкил этиш ва статистик таҳлил қилишнинг Доспехов Б.А. услубияти, шунингдек Ўзбекистон Республикасининг давлат синов методикалари асос қилиб олинган. Ушбу ишларда халқаро ёндашувлар маҳаллий шароитга мослаштирилган [10, 11].", { indent: true }),
        P("Озиқ-овқат хавфсизлиги нуқтаи назаридан Кодекс Алиментариус (FAO/ЖССТ) томонидан белгиланган қолдиқ миқдорнинг рухсат этилган энг юқори даражалари (MRL) муҳим мезон ҳисобланади. Бу эса сақлаш воситаларини нафақат самарадорлиги, балки хавфсизлиги бўйича ҳам баҳолашни тақозо этади [12].", { indent: true }),
        P("Адабиётлар таҳлили шуни кўрсатадики, ҳар бир сақлаш воситаси муайян маҳсулот тури, нави ва маҳаллий сақлаш шароитига нисбатан давлат синовидан ўтказилиши зарур. Мазкур тадқиқот " + prep + " воситасини " + meta.site + " шароитида синаб, ана шу илмий-амалий эҳтиёжни қондиришга қаратилган.", { indent: true }));
    } else {
      ...
      ch.push(H("КИРИШ"),
        ...
        P("Зарарли организмларга қарши курашда механик, агротехник, биологик ва кимёвий усуллар мажмуасидан фойдаланилади. Уйғунлашган ҳимоя тизимида кимёвий усул — ўсимликларни ҳимоя қилиш воситаларини қўллаш — ўзининг тезкорлиги, юқори самарадорлиги ва катта майдонларда қўллаш имконияти билан алоҳида ўрин тутади. Айни вақтда кимёвий воситаларни танлаб, мақбул меъёр ва муддатларда, атроф-муҳит ҳамда фойдали организмларга зарар етказмаган ҳолда қўллаш талаб этилади.", { indent: true }),
  ...
  function generateDocx(rep, meta) {
    ...
    return Promise.all(chartPromises).then(function (charts) {
      ...
      var gostField = [
        ...
        "Henderson, C. F. Tests with acaricides against the brown wheat mite / C. F. Henderson, E. W. Tilton // Journal of Economic Entomology. – 1955. – Vol. 48, № 2. – P. 157–161.",
      ...
      var gostStorage = [
        ...
        "Ўсимликларни ҳимоя қилиш воситаларини рўйхатга олиш бўйича давлат синовларини ўтказиш услубий кўрсатмалари. – Тошкент : Ўсимликлар карантини ва ҳимояси агентлиги, 2020.",
        "ГОСТ 7.1–2003. Библиографическая запись. Библиографическое описание. Общие требования и правила составления. – Москва : Изд-во стандартов, 2004. – 48 с."
      ];
