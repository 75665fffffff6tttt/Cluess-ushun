  ...
  function computeReport(input) {
    ...
    if (A.counts) {
      ...
      input.variants.forEach(function (v) {
        ...
        days.forEach(function (d) { var val = d1 && d1.byDay[d] != null ? d1.byDay[d] : null; bd[d] = round(val); });
