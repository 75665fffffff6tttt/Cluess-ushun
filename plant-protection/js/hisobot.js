...
(function () {
  ...
  function storageTables(ch, rep, meta) {
    ...
    ch.push(P(tr("1-жадвал", "Таблица 1"), { align: "right", size: TBL, after: 40 }),
      P(tr(meta.crop + " маҳсулотини сақлашда " + meta.preparatName + " препаратининг самарадорлиги (турғорлик ва касалланиш даражаси)", "Эффективность препарата " + meta.preparatName + " при хранении продукции " + lcFirst(meta.crop) + " (твёрдость и степень поражения)"), { bold: true, align: "center", size: BODY }));
    ...
    ch.push(P("", { after: 120 }), P(tr("2-жадвал", "Таблица 2"), { align: "right", size: TBL, after: 40 }),
      P(tr(meta.crop + " маҳсулотини сақлашда касалланган мевалар оғирлиги ва биологик самарадорлик", "Масса поражённых плодов и биологическая эффективность при хранении продукции " + lcFirst(meta.crop)), { bold: true, align: "center", size: BODY }));
  ...
  function buildReport(rep, meta) {
    ...
    if (rep.storage) {
      ...
      ch.push(H(tr("КИРИШ", "ВВЕДЕНИЕ")),
        ...
        P(tr("Мазкур илмий ҳисобот " + prep + " (таъсир этувчи модда – " + ai + ") препаратининг " + tl + " сифатида " + lcFirst(crop) + " экинида " + org + "га қарши биологик самарадорлигини давлат синови методикаси асосида аниқлашга бағишланган. Тадқиқотнинг асосий мақсади — препаратнинг " + meta.applicationRate + " сарф меъёридаги самарадорлигини баҳолаш, уни эталон (андоза) " + meta.referenceName + " билан таққослаш, ҳосилдорликка таъсирини ўрганиш ва Давлат рўйхатига киритиш бўйича асосланган хулоса тайёрлашдан иборат. Синов " + meta.site + "да, " + lcFirst(crop) + " экинининг «" + variety + "» навида ўтказилди.", "Настоящий научный отчёт посвящён определению биологической эффективности препарата " + prep + " (действующее вещество – " + ai + ") в качестве " + tl + "а против " + org + " на культуре " + lcFirst(crop) + " на основе государственной методики испытаний. Основная цель исследования — оценить эффективность препарата при норме расхода " + meta.applicationRate + ", сравнить его с эталоном " + meta.referenceName + ", изучить влияние на урожайность и подготовить обоснованное заключение о включении в Государственный реестр. Испытание проведено в " + meta.site + ", на сорте «" + variety + "» культуры " + lcFirst(crop) + "."), { indent: true }),
