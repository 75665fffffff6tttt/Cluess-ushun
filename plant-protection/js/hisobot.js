...
(function () {
  ...
  function computeReport(input) {
    ...
    return {
      ...
      countRows: countRows, efficacyRows: efficacyRows, efficacyMethodLabel: methodLabel(methodKey),
  ...
  function buildReport(rep, meta) {
    ...
    if (rep.storage) {
      ...
      ch.push(H(tr("1. Адабиётлар шарҳи", "1. Обзор литературы")),
        P(tr("Ўсимликларни ҳимоя қилиш воситаларининг биологик самарадорлигини баҳолаш халқаро миқёсда стандартлаштирилган методикаларга асосланади. Европа ва Ўрта ер денгизи ўсимликларни ҳимоя қилиш ташкилоти (EPPO) нинг PP1 туркумидаги стандартлари, БМТнинг Озиқ-овқат ва қишлоқ хўжалиги ташкилоти (FAO) ҳамда Иқтисодий ҳамкорлик ва тараққиёт ташкилоти (OECD) нинг йўриқномалари синов дизайни, ҳисоб-китоб усуллари ва натижаларни талқин қилишда ягона ёндашувни белгилайди [1, 2].", "Оценка биологической эффективности средств защиты растений основывается на международно стандартизированных методиках. Стандарты серии PP1 Европейской и Средиземноморской организации по защите растений (EPPO), руководства Продовольственной и сельскохозяйственной организации ООН (FAO) и Организации экономического сотрудничества и развития (OECD) устанавливают единый подход к дизайну испытаний, методам расчёта и интерпретации результатов [1, 2]."), { indent: true }),
        P(tr("Самарадорликни ҳисоблашда халқаро амалиётда бир қатор классик усуллар қўлланилади. Зараркунандаларга қарши воситалар учун Abbott (1925) ва Henderson–Tilton (1955) формулалари, шунингдек Schneider–Orelli тузатиши, касалликларга қарши препаратлар учун касалланиш даражаси ва ривожланиш индексига асосланган EPPO усуллари, бегона ўтларга қарши гербицидлар учун эса зичлик ва биомасса бўйича ҳисоблаш методлари кенг тарқалган [3, 4]. Ушбу усуллар турли мамлакатларда ўтказилган тадқиқотлар натижаларини қиёслаш имконини беради.", "В международной практике при расчёте эффективности применяется ряд классических методов. Для средств против вредителей широко распространены формулы Abbott (1925) и Henderson–Tilton (1955), а также поправка Schneider–Orelli; для препаратов против болезней — методы EPPO, основанные на степени поражения и индексе развития; для гербицидов против сорняков — методы расчёта по плотности и биомассе [3, 4]. Эти методы позволяют сопоставлять результаты исследований, проведённых в разных странах."), { indent: true }),
        P(tr("Таъсир этувчи модда " + ai + " ва унга ўхшаш препаратлар бўйича хорижий адабиётларда уларнинг таъсир механизми, мақсадли организмлар спектри ҳамда танланувчанлиги батафсил ўрганилган. Дала ва лаборатория тажрибаларида ушбу гуруҳ препаратлари мақсадли зарарли организмларга нисбатан юқори биологик фаоллик кўрсатиши, айни вақтда маданий ўсимликка нисбатан танланувчан таъсир этиши қайд этилган [5, 6, 7].", "В зарубежной литературе подробно изучены механизм действия, спектр целевых организмов и избирательность действующего вещества " + ai + " и аналогичных препаратов. В полевых и лабораторных опытах отмечено, что препараты этой группы проявляют высокую биологическую активность против целевых вредных организмов и при этом оказывают избирательное действие по отношению к культурному растению [5, 6, 7]."), { indent: true }),
        P(tr("Халқаро тадқиқотларда препаратлар самарадорлиги об-ҳаво шароити, қўллаш муддати, зарарли организм ривожланиш фазаси ва сарф меъёрига боғлиқлиги алоҳида таъкидланади. Кўплаб муаллифлар воситани зарарли организм ривожланишининг дастлабки босқичларида қўллаш энг юқори самара беришини кўрсатган [8, 9]. Шунингдек, резистентликнинг олдини олиш мақсадида таъсир механизми турлича бўлган препаратларни навбатлаб қўллаш (IRAC, FRAC, HRAC тавсиялари) муҳим омил сифатида эътироф этилади [10].", "В международных исследованиях особо подчёркивается зависимость эффективности препаратов от погодных условий, срока применения, фазы развития вредного организма и нормы расхода. Многие авторы показали, что применение средства на ранних стадиях развития вредного организма даёт наибольший эффект [8, 9]. Кроме того, в целях предотвращения резистентности важным фактором признаётся чередование препаратов с различным механизмом действия (рекомендации IRAC, FRAC, HRAC) [10]."), { indent: true }),
        P(tr("Маҳаллий ва МДҲ мамлакатлари тадқиқотчилари ишларида дала тажрибаларини ташкил этиш ва статистик таҳлил қилишнинг Доспехов Б.А. услубияти, шунингдек Ўзбекистон Республикасининг давлат синов методикалари асос қилиб олинган. Ушбу ишларда халқаро ёндашувлар маҳаллий тупроқ-иқлим шароитига мослаштирилиб, минтақа учун самарали ҳимоя тизимлари ишлаб чиқилган [11, 12].", "В работах местных исследователей и учёных стран СНГ за основу приняты методика организации полевых опытов и статистической обработки Б.А. Доспехова, а также государственные методики испытаний Республики Узбекистан. В этих работах международные подходы адаптированы к местным почвенно-климатическим условиям, разработаны эффективные системы защиты для региона [11, 12]."), { indent: true }),
    ...
    ch.push(H(tr("3. Синов ўтказиш жойи ва услублари (методикаси)", "3. Место и методы (методика) проведения испытания")),
      P(tr("" + meta.preparatName + " препарати биологик самарадорлиги давлат синов методикаси, ҳосилдорлик Б.А.Доспехов (1985) усулида олиб борилди. Ҳисоблаш методикаси: " + rep.efficacyMethodLabel + ".", "Биологическая эффективность препарата " + meta.preparatName + " определялась по государственной методике испытаний, урожайность — по методу Б.А. Доспехова (1985). Методика расчёта: " + rep.efficacyMethodLabel + "."), { indent: true }));
    if (rep.storage) {
  ...
  function generateDocx(rep, meta) {
    ...
    var chartPromises = [];
    if (best && rep.days.length && !rep.storage) chartPromises.push(svgToPng(barSvg(tr("Биологик самарадорлик — ", "Биологическая эффективность — ") + best.variant + ", %", rep.days.map(String), rep.days.map(function (d) { return best.byDay[d]; }), 100)).then(function (png) { return { type: "eff", png: png, variant: best.variant }; }));
