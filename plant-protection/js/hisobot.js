    ...
    return Promise.all(chartPromises).then(function (charts) {
      ...
      var recText = rep.methodKey === "fert"
        ...
        ? (recommend
          ...
          : tr("Эришилган " + rep.defolWord + " даражаси 60% дан паст (" + fmt(overallBest, 1) + "%) бўлгани сабабли рўйхатга олишга тавсия этилмайди; синовлар давом эттирилсин.", "Поскольку достигнутая степень " + rep.defolWord.replace(/ция$/, "ции") + " ниже 60% (" + fmt(overallBest, 1) + "%), к регистрации не рекомендуется; продолжить испытания."))
        : recommend
      ...
      var actRecommend = (rep.methodKey === "fert") ? (overallBest != null && overallBest > 0) : (overallBest != null && overallBest >= 60);
      var actField12 = tr(
