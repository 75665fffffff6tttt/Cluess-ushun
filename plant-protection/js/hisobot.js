  ...
  function generateDocx(rep, meta) {
    ...
    return Promise.all(chartPromises).then(function (charts) {
      ...
      if (rep.storage) {
        ...
        ch.push(P(tr((n + 1) + ". Тажриба натижаларидан келиб чиққан ҳолда " + meta.preparatName + " (" + meta.applicationRate + ") воситасини " + lcFirst(meta.crop) + " маҳсулотини сақлашда " + lcFirst(meta.targetOrganism) + "нинг олдини олиш учун Давлат рўйхатига киритиш тавсия этилади.", (n + 1) + ". Исходя из результатов опыта, рекомендуется включить средство " + meta.preparatName + " (" + meta.applicationRate + ") в Государственный реестр для предотвращения " + lcFirst(meta.targetOrganism) + " при хранении продукции " + lcFirst(meta.crop) + "."), { indent: true }));
      } else {
