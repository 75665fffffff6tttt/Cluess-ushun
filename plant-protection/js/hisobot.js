...
(function () {
  ...
  function computeReport(input) {
    ...
    if (A.counts) {
      ...
      // Дефолиант/десикант: эришилган дефолиация (қуриш) даражаси % — тўғридан-тўғри, назорат ҳам кўрсатилади
      methodKey = "defol";
      input.variants.forEach(function (v) {
        var isC = !!v.isControl || v.name === control, d1 = A.defol[v.name], bd = {};
        days.forEach(function (d) { var val = (d1 && d1.byDay && d1.byDay[d] != null) ? d1.byDay[d] : null; bd[d] = round(val); });
        efficacyRows.push({ variant: v.name, isControl: isC, isReference: !!v.isReference, byDay: bd, mean: avg(days.map(function (d) { return bd[d]; })) });
      });
    } else if (A.weeds) {
      methodKey = "weed";
  ...
  function effTable(rep) {
    var rows = [];
    var isDefol = rep.methodKey === "defol"; // дефолиацияда назорат ҳам ўз қийматини кўрсатади
    ...
    rep.efficacyRows.forEach(function (r) {
      ...
      rep.days.forEach(function (dd) { c.push(CELL((r.isControl && !isDefol) ? "—" : fmt(r.byDay[dd], 1))); });
      c.push(CELL((r.isControl && !isDefol) ? "—" : fmt(r.mean, 1)));
  ...
  function storageTables(ch, rep, meta) {
    ...
    ch.push(P(tr("1-жадвал", "Таблица 1"), { align: "right", size: TBL, after: 40 }),
      P(tr(meta.crop + " маҳсулотини сақлашда " + meta.preparatName + " препаратининг самарадорлиги (турғорлик ва касалланиш даражаси)", "Эффективность препарата " + meta.preparatName + " при хранении продукции " + cropMid(meta.crop) + " (твёрдость и степень поражения)"), { bold: true, align: "center", size: BODY }));
    ...
    ch.push(P("", { after: 120 }), P(tr("2-жадвал", "Таблица 2"), { align: "right", size: TBL, after: 40 }),
      P(tr(meta.crop + " маҳсулотини сақлашда касалланган мевалар оғирлиги ва биологик самарадорлик", "Масса поражённых плодов и биологическая эффективность при хранении продукции " + cropMid(meta.crop)), { bold: true, align: "center", size: BODY }));
  ...
  // Русча: кўп учрайдиган экинларни қаратқич келишигига («на культуре» / «урожайность» / «продукции» дан кейин)
  var RU_CROP_GEN = {
    "озимая пшеница": "озимой пшеницы", "яровая пшеница": "яровой пшеницы", "мягкая пшеница": "мягкой пшеницы",
    "твёрдая пшеница": "твёрдой пшеницы", "твердая пшеница": "твердой пшеницы", "пшеница": "пшеницы",
    "озимый ячмень": "озимого ячменя", "ячмень": "ячменя", "овёс": "овса", "овес": "овса", "рожь": "ржи",
    "тонковолокнистый хлопчатник": "тонковолокнистого хлопчатника", "хлопчатник": "хлопчатника", "хлопок": "хлопка",
    "рис": "риса", "кукуруза": "кукурузы", "сорго": "сорго", "просо": "проса",
    "картофель": "картофеля", "томат": "томата", "помидор": "помидора", "огурец": "огурца",
    "лук": "лука", "чеснок": "чеснока", "морковь": "моркови", "капуста": "капусты",
    "сахарная свёкла": "сахарной свёклы", "сахарная свекла": "сахарной свеклы", "свёкла": "свёклы", "свекла": "свеклы",
    "перец": "перца", "баклажан": "баклажана", "дыня": "дыни", "арбуз": "арбуза", "тыква": "тыквы",
    "виноград": "винограда", "яблоня": "яблони", "яблоко": "яблока", "груша": "груши", "айва": "айвы",
    "персик": "персика", "абрикос": "абрикоса", "черешня": "черешни", "вишня": "вишни", "слива": "сливы",
    "гранат": "граната", "хурма": "хурмы", "инжир": "инжира", "миндаль": "миндаля", "орех": "ореха",
    "соя": "сои", "подсолнечник": "подсолнечника", "люцерна": "люцерны", "горох": "гороха",
    "фасоль": "фасоли", "нут": "нута", "маш": "маша", "чечевица": "чечевицы",
    "табак": "табака", "клубника": "клубники", "земляника": "земляники"
  };
  function ruCropGen(crop) {
    var s = (crop || "").trim(); if (!s) return s;
    var low = s.toLowerCase();
    if (RU_CROP_GEN[low]) return RU_CROP_GEN[low];
    var keys = Object.keys(RU_CROP_GEN).sort(function (a, b) { return b.length - a.length; });
    for (var i = 0; i < keys.length; i++) { if (low.indexOf(keys[i]) >= 0) return RU_CROP_GEN[keys[i]]; }
    // содда морфологик fallback (бир сўзли): -ца→-цы, -а→-ы, -я→-и
    if (/ца$/.test(low)) return low.replace(/ца$/, "цы");
    if (/[бвгджзйклмнпрстфхцчшщ]а$/.test(low)) return low.replace(/а$/, "ы");
    if (/[бвгджзйклмнпрстфхцчшщ]я$/.test(low)) return low.replace(/я$/, "и");
    return lcFirst(s);
  }
  // Тил-огоҳ экин номи: русчада қаратқич, ўзбекчада кичик ҳарф (танланмаган тил барибир ташланади)
  function cropMid(c) { return LANG === "ru" ? ruCropGen(c) : lcFirst(c); }
  ...
  function buildReport(rep, meta) {
    ...
    ch.push(P(rep.methodKey === "fert"
      ? tr(
        meta.crop + " экинида " + meta.preparatName + titleMaker(meta) + " микробиологик ўғитининг ҳосилдорликка таъсири бўйича рўйхатга олиш учун синов натижалари",
        "Результаты испытаний для регистрации влияния микробиологического удобрения " + meta.preparatName + titleMaker(meta) + " на урожайность культуры " + cropMid(meta.crop)
      )
      : rep.methodKey === "defol"
      ? tr(
        meta.crop + " экинида " + meta.preparatName + titleMaker(meta) + " препаратининг " + rep.typeNameUz.toLowerCase() + " сифатидаги самарадорлиги бўйича рўйхатга олиш учун синов натижалари",
        "Результаты испытаний для регистрации эффективности препарата " + meta.preparatName + titleMaker(meta) + " в качестве " + rep.typeNameUz.toLowerCase() + "а на культуре " + cropMid(meta.crop)
      )
      : tr(
        ...
        "Результаты испытаний для регистрации биологической эффективности препарата " + meta.preparatName + titleMaker(meta) + " против " + orgTitle + " на культуре " + cropMid(meta.crop)
      ), { align: "center", after: 600 }));
    // Масъул ижрочи / Ижрочилар — ном ёнида имзо чекишга жой (чизиқ)
    if (staffList.length) {
      ...
      ch.push(new D.Table({
        ...
        rows: [
          new D.TableRow({ children: [
            new D.TableCell(Object.assign({}, noB, { children: [P(tr("Масъул ижрочи:", "Ответственный исполнитель:"), { after: 480 })] })),
    ...
    // Дефолиант/десикант ва ўғитда зарарли организм бўлмайди — бўш ўринни нейтрал ибора билан тўлдирамиз
    var orgSafe = org || tr("зарарли ва номақбул омиллар", "неблагоприятные факторы");
    var isDefolType = rep.methodKey === "defol";
    var defolAgentRu = tl + "а"; // «дефолианта» / «десиканта»
    // Эталон кўрсатилмаган бўлса — «эталон билан таққослаш» жумласи тушиб қолсин
    var hasRef = !!(meta.referenceName && meta.referenceName.trim());
    var refCompareUz = hasRef ? ", уни эталон (андоза) " + meta.referenceName + " билан таққослаш" : "";
    var refCompareRu = hasRef ? ", сравнить его с эталоном " + meta.referenceName : "";
    ...
    if (rep.storage) {
      ...
      ch.push(H(tr("КИРИШ", "ВВЕДЕНИЕ")),
        ...
        P(tr("Мазкур илмий ҳисобот " + prep + " (таъсир этувчи модда – " + ai + ") воситасининг " + cropMid(crop) + " маҳсулотини сақлаш жараёнида " + org + "га қарши биологик самарадорлигини аниқлашга бағишланган. Тадқиқотнинг асосий мақсади — воситанинг " + meta.applicationRate + " сарф меъёридаги самарадорлигини баҳолаш" + refCompareUz + ", маҳсулот турғорлиги ва сифатига таъсирини ўрганиш ҳамда Давлат рўйхатига киритиш бўйича асосланган хулоса тайёрлашдан иборат. Синов " + meta.site + "да, «" + variety + "» навида ўтказилди.", "Настоящий научный отчёт посвящён определению биологической эффективности средства " + prep + " (действующее вещество – " + ai + ") против " + org + " в процессе хранения продукции " + cropMid(crop) + ". Основная цель исследования — оценить эффективность средства при норме расхода " + meta.applicationRate + refCompareRu + ", изучить влияние на твёрдость и качество продукции, а также подготовить обоснованное заключение о включении в Государственный реестр. Испытание проведено в " + meta.site + ", на сорте «" + variety + "»."), { indent: true }));
      ...
      ch.push(H(tr("КИРИШ", "ВВЕДЕНИЕ")),
        ...
        P(rep.methodKey === "fert"
          ? tr("Мазкур илмий ҳисобот " + prep + " (таъсир этувчи модда – " + ai + ") микробиологик ўғитининг " + cropMid(crop) + " экинида ҳосилдорлик ва ўсимлик ривожига таъсирини аниқлашга бағишланган. Тадқиқотнинг асосий мақсади — ўғитнинг " + meta.applicationRate + " меъёридаги самарадорлигини ҳосилдорлик ошиши бўйича баҳолаш" + refCompareUz + " ва Давлат рўйхатига киритиш бўйича асосланган хулоса тайёрлашдан иборат. Синов " + meta.site + "да, " + cropMid(crop) + " экинининг «" + variety + "» навида ўтказилди.", "Настоящий научный отчёт посвящён определению влияния микробиологического удобрения " + prep + " (действующее вещество – " + ai + ") на урожайность и развитие растений культуры " + cropMid(crop) + ". Основная цель исследования — оценить эффективность удобрения при норме " + meta.applicationRate + " по прибавке урожайности" + refCompareRu + " и подготовить обоснованное заключение о включении в Государственный реестр. Испытание проведено в " + meta.site + ", на сорте «" + variety + "» культуры " + cropMid(crop) + ".")
          : rep.methodKey === "defol"
          ? tr("Мазкур илмий ҳисобот " + prep + " (таъсир этувчи модда – " + ai + ") препаратининг " + tl + " сифатида " + cropMid(crop) + " экинида биологик самарадорлигини (эришилган " + rep.defolWord + " даражасини) давлат синови методикаси асосида аниқлашга бағишланган. Тадқиқотнинг асосий мақсади — препаратнинг " + meta.applicationRate + " сарф меъёридаги самарадорлигини баҳолаш" + refCompareUz + " ва Давлат рўйхатига киритиш бўйича асосланган хулоса тайёрлашдан иборат. Синов " + meta.site + "да, " + cropMid(crop) + " экинининг «" + variety + "» навида ўтказилди.", "Настоящий научный отчёт посвящён определению биологической эффективности препарата " + prep + " (действующее вещество – " + ai + ") в качестве " + defolAgentRu + " на культуре " + cropMid(crop) + " (по достигнутой степени " + rep.defolWord.replace(/ция$/, "ции") + ") на основе государственной методики испытаний. Основная цель исследования — оценить эффективность препарата при норме расхода " + meta.applicationRate + refCompareRu + " и подготовить обоснованное заключение о включении в Государственный реестр. Испытание проведено в " + meta.site + ", на сорте «" + variety + "» культуры " + cropMid(crop) + ".")
          : tr("Мазкур илмий ҳисобот " + prep + " (таъсир этувчи модда – " + ai + ") препаратининг " + tl + " сифатида " + cropMid(crop) + " экинида " + org + "га қарши биологик самарадорлигини давлат синови методикаси асосида аниқлашга бағишланган. Тадқиқотнинг асосий мақсади — препаратнинг " + meta.applicationRate + " сарф меъёридаги самарадорлигини баҳолаш" + refCompareUz + ", ҳосилдорликка таъсирини ўрганиш ва Давлат рўйхатига киритиш бўйича асосланган хулоса тайёрлашдан иборат. Синов " + meta.site + "да, " + cropMid(crop) + " экинининг «" + variety + "» навида ўтказилди.", "Настоящий научный отчёт посвящён определению биологической эффективности препарата " + prep + " (действующее вещество – " + ai + ") в качестве " + tl + "а против " + org + " на культуре " + cropMid(crop) + " на основе государственной методики испытаний. Основная цель исследования — оценить эффективность препарата при норме расхода " + meta.applicationRate + refCompareRu + ", изучить влияние на урожайность и подготовить обоснованное заключение о включении в Государственный реестр. Испытание проведено в " + meta.site + ", на сорте «" + variety + "» культуры " + cropMid(crop) + "."), { indent: true }),
    ...
    ch.push(H(tr("3. Синов ўтказиш жойи ва услублари (методикаси)", "3. Место и методы (методика) проведения испытания")),
      P(tr(
        (meta.site ? "Синов " + meta.site + "да ўтказилди. " : "") + meta.preparatName + " препарати биологик самарадорлиги давлат синов методикаси бўйича, ҳосилдорлик эса умумқабул қилинган дала тажрибаси услубида олиб борилди. Ҳисоблаш методикаси: " + rep.efficacyMethodLabel + ".",
        (meta.site ? "Испытание проведено в " + meta.site + ". " : "") + "Биологическая эффективность препарата " + meta.preparatName + " определялась по государственной методике испытаний, урожайность — по общепринятой методике полевого опыта. Методика расчёта: " + rep.efficacyMethodLabel + "."
      ), { indent: true }));
    if (rep.storage) {
  ...
  function generateDocx(rep, meta) {
    ...
    return Promise.all(chartPromises).then(function (charts) {
      ...
      if (rep.yieldRows && rep.yieldRows.length) {
        ch.push(P(tr("3-жадвал", "Таблица 3"), { align: "right", size: TBL, after: 40 }), P(tr(meta.preparatName + " препаратининг " + cropMid(meta.crop) + " ҳосилдорлигига таъсири", "Влияние препарата " + meta.preparatName + " на урожайность " + cropMid(meta.crop)), { bold: true, align: "center", size: BODY }));
      ...
      // Тавсия шарти: биологик самарадорлик 70% дан паст бўлса — рўйхатга тавсия этилмайди
      // Пестицид: самарадорлик ≥70% → тавсия. Микроб ўғит: ҳосилдорлик ижобий (мумкин бўлса — статистик ишончли) ошса → тавсия
      var recommend = rep.methodKey === "fert"
        ...
        : (overallBest != null && overallBest >= 70);
      if (rep.storage) {
        ...
        ch.push(P(recommend
          ? tr((n + 1) + ". Тажриба натижаларидан келиб чиққан ҳолда " + meta.preparatName + " (" + meta.applicationRate + ") воситасини " + cropMid(meta.crop) + " маҳсулотини сақлашда " + lcFirst(meta.targetOrganism) + "нинг олдини олиш учун Давлат рўйхатига киритиш тавсия этилади.", (n + 1) + ". Исходя из результатов опыта, рекомендуется включить средство " + meta.preparatName + " (" + meta.applicationRate + ") в Государственный реестр для предотвращения " + lcFirst(meta.targetOrganism) + " при хранении продукции " + cropMid(meta.crop) + ".")
          : tr((n + 1) + ". Самарадорлик кўрсаткичи 70% дан паст (" + fmt(overallBest, 1) + "%) бўлгани сабабли " + meta.preparatName + " воситасини Давлат рўйхатига киритиш ушбу синов натижалари асосида тавсия этилмайди; синовларни такрорлаш ёки давом эттириш тавсия этилади.", (n + 1) + ". Поскольку показатель эффективности ниже 70% (" + fmt(overallBest, 1) + "%), включение средства " + meta.preparatName + " в Государственный реестр по результатам данного испытания не рекомендуется; рекомендуется повторить или продолжить испытания."), { indent: true }));
      } else {
        ...
        ch.push(P(rep.methodKey === "fert"
          ...
          : tr("4. Биологик самарадорлик 70% дан паст (" + fmt(overallBest, 1) + "%) бўлгани сабабли " + meta.preparatName + " препаратини Давлат рўйхатига киритиш ушбу синов натижалари асосида тавсия этилмайди; синовларни такрорлаш ёки давом эттириш тавсия этилади.", "4. Поскольку биологическая эффективность ниже 70% (" + fmt(overallBest, 1) + "%), включение препарата " + meta.preparatName + " в Государственный реестр по результатам данного испытания не рекомендуется; рекомендуется повторить или продолжить испытания."), { indent: true }));
      }
      ...
      var recText = rep.methodKey === "fert"
        ...
        : rep.methodKey === "defol"
        ? (recommend
          ? tr("«" + meta.preparatName + "» " + meta.applicationRate + " сарф-меъёрда " + cropMid(meta.crop) + " экинида " + rep.typeNameUz.toLowerCase() + " сифатида рўйхатга олишга тавсия этилсин.", "Рекомендовать «" + meta.preparatName + "» к регистрации при норме расхода " + meta.applicationRate + " в качестве " + rep.typeNameUz.toLowerCase() + "а на культуре " + cropMid(meta.crop) + ".")
          : tr("Эришилган " + rep.defolWord + " даражаси 70% дан паст (" + fmt(overallBest, 1) + "%) бўлгани сабабли рўйхатга олишга тавсия этилмайди; синовлар давом эттирилсин.", "Поскольку достигнутая степень " + rep.defolWord.replace(/ция$/, "ции") + " ниже 70% (" + fmt(overallBest, 1) + "%), к регистрации не рекомендуется; продолжить испытания."))
        : recommend
        ...
        : tr("Биологик самарадорлик 70% дан паст (" + fmt(overallBest, 1) + "%) бўлгани сабабли рўйхатга олишга тавсия этилмайди; рўйхатга олиш учун синовлар давом эттирилсин.", "Поскольку биологическая эффективность ниже 70% (" + fmt(overallBest, 1) + "%), к регистрации не рекомендуется; продолжить испытания для регистрации.");
      ...
      form1.push(new D.Table({
        ...
        rows: [new D.TableRow({ children: [
          ...
          new D.TableCell({ borders: {}, children: [P(tr("Масъул ижрочи", "Ответственный исполнитель"), { bold: true, before: 200, after: 0 })] }),
      ...
      var appendix = [P(tr("ИЛОВА", "ПРИЛОЖЕНИЕ"), { align: "center", bold: true, size: 32, after: 200 }),
        ...
        new D.Paragraph({ children: [new D.PageBreak()] }),
        P(tr("ЎСИМЛИКЛАРНИ ҲИМОЯ ҚИЛИШ ВОСИТАСИНИНГ СИНОВ", "АКТ"), { align: "center", bold: true, size: 28, after: 0 }),
        P(tr("НАТИЖАЛАРИ БЎЙИЧА", "ПО РЕЗУЛЬТАТАМ ИСПЫТАНИЯ"), { align: "center", bold: true, size: 28, after: 0 }),
        P(tr("ДАЛОЛАТНОМА", "СРЕДСТВА ЗАЩИТЫ РАСТЕНИЙ"), { align: "center", bold: true, size: 28, after: 160 }),
      ...
      var actRecommend = (rep.methodKey === "fert") ? (overallBest != null && overallBest > 0) : (overallBest != null && overallBest >= 70);
      var actField12 = tr(
        "Синов давомида препаратни қўллашда камчиликлар (фитотоксиклик белгилари) кузатилмади." + (actRecommend ? " Препарат белгиланган меъёрларда самарали бўлиб, ишлаб чиқаришда қўллаш учун тавсия этилади." : ""),
        "В ходе испытания недостатков (признаков фитотоксичности) при применении препарата не наблюдалось." + (actRecommend ? " Препарат эффективен в установленных нормах и рекомендуется к применению в производстве." : "")
      );
      appendix.push(
        actItem("1", tr("Ушбу далолатномани тузувчилар Ф.И.О", "Составители настоящего акта Ф.И.О"), actStaff.join(", ")),
        ...
        actItem("12", tr("Хулосалар, камчиликлар ва тавсиялар", "Выводы, недостатки и рекомендации"), actField12),
